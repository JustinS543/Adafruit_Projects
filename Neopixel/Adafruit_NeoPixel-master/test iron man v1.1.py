...
num_pix = 60  # Number of NeoPixels
pix_pin = board.A1  # Pin where NeoPixels are connected
strip = neopixel.NeoPixel(pix_pin, num_pix)

min_alpha = 0.1  # Minimum brightness
max_alpha = 0.8  # Maximum brightness
...
while True:
    ...
    if cp.button_b:
        strip.fill([0, 255, 0])  # Fill blue, or change to R,G,B of your liking
